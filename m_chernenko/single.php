	...
	<main class="main-content">
		<div class="grid-container">
			<div class="grid-x grid-margin-x">
				...
				<div class="grid-x large-8 medium-8 small-12 cell">
                    <a class="custom-button" href="<?php echo esc_url(get_page_link(22)) ?>?post_id=<?php echo get_the_ID() ?>">Contact page</a>
					<?php if ( have_posts() ) : ?>
